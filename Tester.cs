...

{
    ...
    class Tester
    {
                private static void Main(string[] args)
        {
            ...
            colorManual.printManual(new ManualPrinter());
            ManualTester _tester=new ManualTester();
            colorManual.printManual(_tester);
            Debug.Assert(_tester.content[0]=="Pair Number: 1, Colors:: majorColor: Color [White] minorColor: Color [Blue]");
            Debug.Assert(_tester.content.Count==25);
        }
    }
}